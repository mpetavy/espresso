...
func init() {
	common.Init(false, "1.0.6", "", "2017", "JNLP app launcher as an alternative to Java Webstart", "mpetavy", fmt.Sprintf("https://github.com/mpetavy/%s", common.Title()), common.APACHE, nil, nil, run, 0)
